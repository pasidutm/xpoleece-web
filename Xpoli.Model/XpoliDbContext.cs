...
namespace Listing.Model
{
    public class XpoliDbContext : DbContext
    {
        ...
        private void LoadData()
        {
            ...
            this.Status.Add(new StatusDetails { Id = 500, Status = "Internal Server Error", Description = "The server encountered an unexpected condition which prevented it from fulfilling the request." });
